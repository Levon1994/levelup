...
const languages =  {
    am: {
        header_students: 'Ուսանողներ',
        header_courses: 'Դասընթացներ',
        ...
        apply_form_name: 'Անուն',
        apply_form_surname: 'Ազգանուն',
    ...
    uk: {
        ...
        apply: 'Apply',
        apply_now: 'Apply now',
        apply_form_name: 'Name',
        apply_form_surname: 'Surname',
        apply_form_age: 'Age',
